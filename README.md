...
| `spec_checklist`     | —                                                 | Returns the planning checklist grouped by category, each with 2-4 concrete questions to ask the user.                                                                                                                                                                                                                                   |
